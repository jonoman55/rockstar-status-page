...
const RockstarStatusItem = ({ services, statuses, updated }) => (
    <Paper component={Link} href="https://support.rockstargames.com/servicestatus" target='_blank' sx={{
        p: 2, mt: 2, mr: 0.5, color: 'primary.contrastText', bgcolor: 'primary.main', textDecoration: 'none', minHeight: '202px',
        ...
        <Stack direction='row' sx={{
            pt: 1, display: 'flex', flexDirection: 'row', flexWrap: 'nowrap', alignItems: 'center'
        }}>
            <Typography variant='body1' sx={{ pr: 1 }}>Statuses</Typography>
            <Typography variant='body1' sx={{
                color: `${styleStatus(checkStatuses(statuses))}`, fontWeight: 'bold'
            }}>
